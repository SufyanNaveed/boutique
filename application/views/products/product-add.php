                ...
                <form method="post" id="data_form" >
                    ...
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label"
                               for="party_name"><?php echo 'Select Category' ?>*</label>
                        <div class="col-sm-6">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" placeholder="<?php echo $last_product['product_code']; ?>" class="form-control product_code" name="product_code">
                        </div>
                        <div class="col-sm-2">
                            <input type="checkbox" id="auto_generate_code" name="auto_generate_code">&nbsp;&nbsp; Auto Generate code
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label"
                               for="than" id="than_quantity"><?php echo 'Product Quantity' ?>*</label>

                        <div class="col-sm-6">
                            <input type="number" placeholder="enter quantity"
                                   class="form-control" name="product_qty" id="product_qty" onkeypress="return isNumber(event)">
                        </div>
                    </div> 
                    <div class="form-group row">

                        <label class="col-sm-2 col-form-label"><?php echo 'Sale Price' ?></label>
...
<script>
    ...
    $(document).on('click', "#auto_generate_code", function (e) {
        var val = '<?php echo $last_product['product_code']?>'; //Math.floor(100000 + Math.random() * 900000);
        var product_code = val.split("-");
        var serial = product_code[0];
        var post_fix = product_code[1];
        
        var start = serial.substring(0, 2);
        console.log(start);
        
        var middle = parseInt(serial.substring(2,serial.length)) + 1; 
        console.log(middle);
        var full_serial  = start + middle + '-' +post_fix;
        console.log(full_serial); 
        if($("#auto_generate_code").is(':checked')){
            $('.product_code').val(full_serial);
