                ...
                <form method="post" id="data_form" class="form-horizontal">
                    ...
                    <div class="form-group row">
                        ...
                        <label class="col-sm-2 col-form-label"
                               for="product_cat"><?php echo 'Select Category' ?>*</label>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" placeholder="Product Code" class="form-control product_code" name="product_code" value="<?php echo $product['product_code'] ?>" readonly >
                        </div>
                        <!-- <div class="col-sm-2">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label" for="product_code"><?php echo $this->lang->line('Color') ?></label>
                        <div class="col-sm-6">
                            <input type="text" placeholder="Color" class="form-control" name="color" value="<?php echo $product['color'] ?>">
                        </div>
                    </div> 
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label"
                        ...
                        <div class="col-sm-6">
                            <input type="number" placeholder="enter quantity"
                                   class="form-control" name="product_qty" id="product_qty" onkeypress="return isNumber(event)" value="<?php echo $product['qty'] ?>">
                        </div>
                    </div>
