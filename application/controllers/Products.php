...
class Products extends CI_Controller
{
    ...
    public function add()
    {
        ...
        $data['last_product'] = $this->products->last_product();
    ...
    public function apply_discount()
    {
        ...
        $data['last_product'] = $this->products->discount_updated($product_ids, $disrate, $due_date);
    ...
    public function product_list()
    {
        ...
        foreach ($list as $prd) {
            $no++;
            $row = array();
            $row[] = '<input type="checkbox" name="discount_check" class="selected_product_id" value="'.$prd->pid.'">';
            $row[] = $no;
            $pid = $prd->pid;
            ...
            $btns = '<a href="#" data-object-id="' . $pid . '" class="btn btn-success  btn-sm  view-object"><span class="fa fa-eye"></span> ' . $this->lang->line('View') . '</a> 
                    <div class="btn-group">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a class="btn btn-pink  btn-sm" href="' . base_url() . 'products/report_product?id=' . $pid . '" target="_blank"> <span class="fa fa-pie-chart"></span> ' . $this->lang->line('Sales') . '</a> 
                            &nbsp;&nbsp;
                            <div class="btn-group">
    ...
    public function addproduct()
    {
        ...
        //$this->products->addnew($product_name, $warehouse, $product_code, $color, $product_qty,$pro_than_qty, $unit, $pro_than_len, $factoryprice, $product_price, $code_type, $barcode, $taxrate, $disrate, $product_qty_alert, $product_desc, $image, $v_type, $v_stock, $v_alert, $wdate, $catid);
        $this->products->addnew($catid, $warehouse, $product_name, $product_code, $color, $product_price, $factoryprice, $taxrate, $disrate, $product_qty, $product_qty_alert, $product_desc, $image, $unit, $barcode, $v_type, $v_stock, $v_alert, $wdate, $code_type, $w_type = '', $w_stock = '', $w_alert = '', $sub_cat = '', $b_id = '', $serial = '');
    }
    ...
    public function editproduct()
    {
        ...
        $wdate = datefordatabase($this->input->post('wdate'));
        if ($pid) {
            $this->products->edit($pid, $catid, $warehouse, $product_name, $product_code, $color, $product_price, $factoryprice, $taxrate, $disrate, $product_qty, $product_qty_alert, $product_desc, $image, $unit, $barcode, $code_type, $sub_cat = '', $b_id = '', $vari = null, $serial = null);
        }
